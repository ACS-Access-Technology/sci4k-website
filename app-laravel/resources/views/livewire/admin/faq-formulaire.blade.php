...
<form wire:submit="enregistrer" class="max-w-3xl space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <button type="button" wire:click="$dispatch('bloc-annule')" class="text-sm text-zinc-600 hover:underline dark:text-zinc-400">
            {{ __('Annuler') }}
        </button>
    </div>
</form>
