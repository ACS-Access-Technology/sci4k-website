...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap items-center gap-3 text-sm text-zinc-600 dark:text-zinc-400">
        <span>{{ __('Tout ce que montre la page Actualités du site, rassemblé ici.') }}</span>
        <a href="{{ route('actualites.index') }}" target="_blank" rel="noopener"
        ...
        <div class="space-y-6">
            <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                {{-- Deux modules n'ont pas d'en-tete de section : la page
                     n'affiche rien au-dessus du formulaire de recherche ni
                     au-dessus de la grille d'articles. Ni bascule de langue ni
                     formulaire, donc. --}}
