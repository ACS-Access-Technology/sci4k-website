...
--}}
<div class="space-y-6">
    @php($titrePage = __('Page Biens immobiliers'))
    ...
    <div class="flex flex-wrap items-center gap-3 text-sm text-zinc-600 dark:text-zinc-400">
        <span>{{ __('Tout ce que montre la page Biens immobiliers du site, rassemblé ici.') }}</span>
        <a href="{{ route('biens.index') }}" target="_blank" rel="noopener"
    ...
    <div class="grid gap-6 lg:grid-cols-[18rem_minmax(0,1fr)]">
        ...
        {{-- LES TROIS MODULES, DANS L'ORDRE DU SITE --}}
        ...
        <div class="space-y-6">
            <div class="rounded-xl border border-zinc-200 bg-white p-5 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                {{-- Le catalogue n'a pas d'en-tete de section a lui : la page
                     n'en affiche pas au-dessus de la grille. Ni bascule de
                     langue ni formulaire, donc. --}}
