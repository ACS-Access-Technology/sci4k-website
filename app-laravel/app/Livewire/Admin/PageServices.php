...
class PageServices extends Component
{
    ...
    public function enregistrer(): void
    {
        ...
        // Meme raison que l'en-tete : `$options` est une propriete publique,
        // et poserOptions() verse ce qu'on lui donne dans le sac JSON. Sans ce
        // filtre, une cle forgee contournait les `Rule::in` ci-dessus.
        $declarees = $this->optionsFiltrees(
            $this->options,
            array_keys($description['options'] ?? []),
        );
